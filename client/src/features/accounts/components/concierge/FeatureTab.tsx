...
export default function FeatureTab({featureIcon, featureName, featureDesc, onClick, featureTag}:FeatureTabProps){
    return <div className="flex flex-row justify-start items-center w-full h-[70px] m-1 rounded-2xl pl-4 hover:bg-gray-800 hover:cursor-pointer duration-300" onClick={() => onClick(featureTag)}>
